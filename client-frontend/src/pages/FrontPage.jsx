      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-16">
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            Discover the future of education that adapts to every learning
            style, empowering both students and educators to thrive.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            <p className="text-xl text-gray-400 leading-relaxed">
              Powered by cutting-edge technology to transform your educational
              experience
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <div
                    className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center mb-6 transition-all duration-500 group-hover:scale-110 group-hover:rotate-12`}
                  >
                    {feature.icon}
                  </div>
                  ...
                  <div className="flex items-center text-cyan-400 font-semibold opacity-0 group-hover:opacity-100 translate-x-[-10px] group-hover:translate-x-0 transition-all duration-500">
                    Discover More{" "}
                    <GiSpaceship className="ml-2 group-hover:translate-x-1 transition-transform duration-300" />
                  </div>
                </div>
              </div>
            ))}
